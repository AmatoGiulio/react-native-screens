...
5. When the delegate declines nested scroll, the seam is behaviorally inert.
6. The test delegate never owns source fling physics; fling handlers return `false`.
